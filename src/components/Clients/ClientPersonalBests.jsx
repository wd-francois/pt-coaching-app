            ...
            >
                <div className="space-y-4">
                    <div className="flex justify-between items-center">
                        <p className="text-gray-200">Track and manage client personal best lifts</p>
                    ...
                    {loading ? (
                        ...
                        <div className="glass rounded-lg p-12 text-center">
                            ...
                            <p className="text-gray-200 mb-6">Get started by adding the first personal best</p>
                                ...
                                <div key={personalBest.id} className="glass rounded-lg p-4">
                                    ...
                                    {personalBest.notes && (
                                        <div className="mt-3 pt-3 border-t border-white/10">
                                            ...
                                            <p className="text-sm text-gray-100">{personalBest.notes}</p>
                                        </div>
                                    )}
                                </div>
                            ))}
